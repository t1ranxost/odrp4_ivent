...
let eventsData = [
    ...
    { id: 15, name: "Отыгровка полиции", platform: "Дмитрий Морозов", organizer: "Arbuz Madrzo", date: "17.04.26, 17:56 - 19:29", status: "Проведен", rating: "-", members: 125, callStatus: "🟡Скоро", fullDetails: { description: "Я был Командиром 1 отряда. Арбуз Перегвоорщиком. просто рп за полицию. Скринов нету Арбуз потвердит", tasks: "", feedback: "", rewards: "", extra: "" } }
];
